 ...
 *
 * <p>new AuthPolicy(principalId, AuthPolicy.PolicyDocument.getDenyAllPolicy(region, awsAccountId,
 * restApiId, stage));
 *
 * @author Jack Kohn
 */
public class AuthPolicy {
    ...
    public Map<String, Object> getPolicyDocument() {
        ...
        Map[] serializableStatementArray = new Map[statements.length];
    ...
    public static class PolicyDocument {
        ...
        private void addResourceToStatement(Statement statement, HttpMethod httpMethod,
            ...
            statement.addResource(String
                .format(EXECUTE_API_ARN_FORMAT, region, awsAccountId, restApiId, stage, method,
                    resource));
        }
